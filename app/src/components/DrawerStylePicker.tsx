      ...
      {!customMode && (
        <>
          <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(80px, 1fr))', gap: 6, opacity: optionsLoading ? 0.4 : 1, transition: 'opacity 0.3s' }}>
              {styleOptions.map(s => (
                <button
                  key={s.id}
                  className="tb-pill"
          ...
          <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(80px, 1fr))', gap: 6, marginBottom: 10, opacity: optionsLoading ? 0.4 : 1, transition: 'opacity 0.3s' }}>
